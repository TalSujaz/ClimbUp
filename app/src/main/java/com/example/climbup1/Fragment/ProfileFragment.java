...
import com.example.climbup1.AchievementActivity;
import com.example.climbup1.Adapter.MyFotoAdapter;
import com.example.climbup1.EditProfileActivity;
...
import com.example.climbup1.OptionsActivity;
...
public class ProfileFragment extends Fragment {
    ...
    TextView posts,followers,following, bio,username,foryou;
    Button edit_profile;
            ...
            public void onClick(View v) {
                ...
                reference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        editor.putString("filed",user.getFiled());
                        editor.apply();
                        ((FragmentActivity)getContext()).getSupportFragmentManager().beginTransaction().replace(R.id.fragment_continer,new ForYouFragment()).commit();
                    }
